...
for file in "${females[@]}"; do
        ...
        # Align 
        bwa mem -t 16 -o ${file}_mem_mapped.sam $femalereference ${file}_R1.fastq.gz ${file}_R2.fastq.gz 2> ${file}.err
...
for file in "${males[@]}"; do
        ...
        # Align
        bwa mem -t 16 -o ${file}_mem_mapped.sam $malereference ${file}_R1.fastq.gz ${file}_R2.fastq.gz 2> ${file}.err
